      ...
      <div className="w-full max-w-sm bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl shadow-blue-500/5 p-8 flex flex-col items-center border border-blue-100">
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
          ...
          {mode === "login" && (
            <div className="text-right -mt-1">
              <a href="/forgot-password" className="text-xs text-blue-500 hover:text-blue-600">
                Forgot password?
              </a>
            </div>
          )}
        ...
        <div className="w-full flex flex-col gap-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-xl border border-gray-200 hover:bg-gray-50 text-sm font-medium text-gray-700 transition-all"
          >
