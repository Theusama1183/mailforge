  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-50 via-white to-blue-50 p-4">
      <div className="w-full max-w-sm bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl shadow-blue-500/5 p-8 flex flex-col items-center border border-blue-100">
        ...
        <h2 className="text-2xl font-semibold mb-1 text-gray-900">Two-factor auth</h2>
        <p className="text-gray-500 text-sm mb-8 text-center">
          Enter the code from your authenticator app
        </p>

        {error && (
          <div className="w-full px-3 py-2 mb-4 rounded-lg bg-red-50 border border-red-100 text-red-600 text-xs">
            {error}
          </div>
        )}
        ...
        <div className="w-full flex flex-col items-center gap-4">
          ...
          <input
            ...
            maxLength={6}
            autoFocus
            className="w-48 px-4 py-3 text-center text-2xl tracking-[0.5em] rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 bg-gray-50/50 font-mono text-gray-900 placeholder:text-gray-300"
          />
